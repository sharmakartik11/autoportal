...
class LeaseVsLoan extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.site === "jaguar") {
      ...
      document.title = "Lease vs. Loan | Jaguar Financial Group | Chase.com";
    }
    if (this.props.site === "landrover") {
      // createLink.href = "./lr-favicon.ico";
      document.title =
        "Lease vs. Loan | Land Rover Financial Group | Chase.com";
    }
  }
